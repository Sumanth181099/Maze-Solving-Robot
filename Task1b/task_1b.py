# All the functions are written by us.
# The driver code was provided and was asked not to change it.
...
def find_new_path(recv_data, shortestPath):
	...
	new_initial_point = shortestPath[obstacle_index-1] 
